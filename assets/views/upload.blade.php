        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="tab-content borderbox" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade pt-3 show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                <form id="frmPerfios" name="frmPerfios" method="post" target="perfios_popup" action="{{ url('perfios-request') }}" onsubmit="if(!this.terms.checked){document.getElementById('term-msg').innerHTML = 'You must agree to the terms first.';return false}else{ window.open('about:blank','perfios_popup','width=1000,height=800');}">
                ...
                <form id="frmUploadExtraData">
                    <input type="hidden" name="lr_no" value="{{ session_get('lrNo') }}">
                    <input type="hidden" name="lr_contact_srno" value="{{ session_get('contactSrNo') }}">
                    <input type="hidden" name="file_source" value="WEBSITE">
                    ...
                    <input type="hidden" name="uploaded_by" value="{{ session_get('customerName') }}">
                </form>
